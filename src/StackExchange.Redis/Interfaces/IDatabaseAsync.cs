...
namespace StackExchange.Redis
{
    ...
    public interface IDatabaseAsync : IRedisAsync
    {
        ...
        /// <remarks>https://redis.io/commands/lpop</remarks>
        ValueTask<RedisValue[]> ListLeftPopAsync(RedisKey key, long count, CommandFlags flags = CommandFlags.None);
        ...
        /// <returns>Array of values that were popped, or nil if the key doesn't exist</returns>
        /// <remarks>https://redis.io/commands/rpop</remarks>
        ValueTask<RedisValue[]> ListRightPopAsync(RedisKey key, long count, CommandFlags flags = CommandFlags.None);
        ...
        ValueTask<RedisValue> StringGetDeleteAsync(RedisKey key, CommandFlags flags = CommandFlags.None);
